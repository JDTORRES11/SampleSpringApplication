...
<!--================Home Banner Area =================-->
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>Consultar Garantia</h2>
            </div>
            <div class="page_link">
              <a href="helloworld.htm">Home</a>
              <a href="garantiaConsultar.htm">Consultar Garantia</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--================End Home Banner Area =================-->
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Consultar Garantia</h2>
                </div>
			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="garantiaConsultarForm.htm" method="post">
                                            <input type="text" name="numeroV" placeholder="Numero Garantia" required>
