...
<!--================Home Banner Area =================-->
        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="personaRegistrar.htm">Crear Venta</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--================End Home Banner Area =================-->
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Crear Venta</h2>
                </div>
                <div class="col-lg-8">
                    <form action="ventaRegistrar.htm" method="post">
                                            ...
                                            <input type="text" name="vehiculo" id="fullname" class="form-control" placeholder="vehiculo Id">
                                             <input  name="tipog" id="fullname" class="form-control" placeholder="Tipo Garantia" >
