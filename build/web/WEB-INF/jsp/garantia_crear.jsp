...
<!--================Home Banner Area =================-->
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>Crear Garantia</h2>
            </div>
            <div class="page_link">
              <a href="helloworld.htm">Home</a>
              <a href="GarantiaRegistrar.htm">Crear Garantia</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--================End Home Banner Area =================-->
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Crear Garantia</h2>
                </div>
                <div class="col-lg-8">
                    <form action="garantiaRegistrar.htm" method="post">
                                           ...
                                           <input  name="garantia" id="fullname" class="form-control" placeholder="Tipo Garantia">
