...
<!--================Home Banner Area =================-->
        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="personaRegistrar.htm">Crear Vehiculo</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--================End Home Banner Area =================-->
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Crear Vehiculo</h2>
                </div>
                <div class="col-lg-8">
                    <form action="vehiculoRegistrar.htm" method="post">
                                            ...
                                            <input  name="tipov" id="fullname" class="form-control"  placeholder="Tipo Vehiculo">
