...
<!--================Home Banner Area =================-->
        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="personaRegistrar.htm">Crear Persona</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!--================End Home Banner Area =================-->
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Crear Persona</h2>
                </div>
                <div class="col-lg-8">
                    <form action="personaRegistrar.htm" method="post">
                                            ...
                                            <input class="form-control" type="text" name="tipop" placeholder="Tipo Persona" required="">
                                            <input class="form-control" type="date" name="fecha" placeholder="Fecha Nacimiento" required="">
